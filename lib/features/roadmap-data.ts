...
export const ROADMAP_CATEGORIES: RoadmapCategory[] = [
  {
    ...
    features: [
      ...
      { text: 'Inline benefit editing on job detail — reconcile employer contributions per day', status: 'shipped' },
      { text: 'Invoice regeneration — delete and regenerate invoices from job detail', status: 'shipped' },
      { text: 'Invoiced status filter — separate filter for invoiced vs completed jobs', status: 'shipped' },
    ],
  },
  {
    slug: 'time-invoicing',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Paycheck reconciliation — group invoices, track taxes, split deposits across accounts', status: 'shipped' },
      { text: 'Pay stub scanning — Gemini Vision OCR extracts taxes and amounts from photos', status: 'shipped' },
      { text: 'Per-day benefit deductions on time entries with copy-across', status: 'shipped' },
      { text: 'Paycheck portal links — save company pay portal URLs on contacts', status: 'shipped' },
    ],
  },
  {
    slug: 'travel',
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Custom dashboard widgets — pin your most-used modules', status: 'shipped' },
