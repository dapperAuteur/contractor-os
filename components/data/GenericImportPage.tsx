...
export default function GenericImportPage({
  ...
  return (
    <div className="p-4 sm:p-8 max-w-4xl">
      ...
      <div className="bg-amber-500/10 border border-amber-200 rounded-xl p-4 mb-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden mb-6">
          <div className="px-4 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            ...
            <button
              ...
              disabled={importing}
              className="flex items-center gap-1.5 px-4 py-2 bg-amber-600 text-white rounded-lg text-sm font-semibold hover:bg-amber-700 transition disabled:opacity-50"
            >
