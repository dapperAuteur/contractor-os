      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2">
            <ClipboardList className="w-5 h-5 sm:w-6 sm:h-6 text-amber-400" /> Assignments
          </h1>
        </div>
        {!creating && (
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 bg-amber-600 text-white rounded-lg text-sm font-semibold hover:bg-amber-700 transition min-h-11"
          >
        ...
        <div className="dark-input bg-gray-900 border border-gray-800 rounded-xl p-4 sm:p-6 mb-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              disabled={saving}
              className="flex items-center gap-2 px-4 py-3 bg-amber-600 text-white rounded-lg text-sm font-semibold hover:bg-amber-700 transition disabled:opacity-50 min-h-11"
            >
                          ...
                          <div key={sub.id} className="bg-gray-800 rounded-xl p-4">
                            ...
                            {gradingId === sub.id ? (
                              ...
                              <button
                                ...
                                className="text-sm text-amber-400 hover:text-amber-300 transition mt-2 py-1"
                              >
