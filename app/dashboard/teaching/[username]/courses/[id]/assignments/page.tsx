...
// app/dashboard/teaching/[username]/courses/[id]/assignments/page.tsx
  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <Link
            href={`/dashboard/teaching/${username}/courses/${courseId}`}
        ...
        <div className=" bg-white border border-slate-200 rounded-xl p-6 mb-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-amber-500 resize-none"
            />
          </div>
          <div>
            ...
            <input
              ...
              className="bg-slate-100 border border-slate-200 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-amber-500"
            />
          </div>
          <div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-slate-100 text-slate-700 rounded-lg text-sm hover:bg-slate-100 transition"
            >
              Cancel
            </button>
          </div>
            ...
            return (
              <div key={a.id} className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                <button
                  ...
                  className="w-full flex items-center gap-4 px-5 py-4 text-left hover:bg-slate-100/50 transition"
                >
                        ...
                        {subs.map((sub) => (
                          <div key={sub.id} className="bg-slate-100 rounded-xl p-4">
                            <div className="flex items-start justify-between gap-4 mb-3">
                              ...
                              {sub.grade ? (
                                <span className="px-2 py-1 bg-green-900/30 text-green-400 rounded-full text-xs font-medium shrink-0">
                                  {sub.grade}
                                </span>
                              ) : (
                                <span className="px-2 py-1 bg-amber-900/30 text-amber-400 rounded-full text-xs font-medium shrink-0">
                                  Ungraded
                                </span>
                              )}
                            </div>
                            ...
                            {gradingId === sub.id ? (
                              <div className=" space-y-2 mt-3">
                                ...
                                <textarea
                                  ...
                                  rows={3}
                                  className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-amber-500 resize-none"
                                />
                                <div className="flex gap-2">
                                  ...
                                  <button type="button" onClick={() => setGradingId(null)}
                                    className="px-3 py-1.5 bg-gray-700 text-slate-700 rounded-lg text-xs hover:bg-gray-600 transition">
                                    Cancel
                                  </button>
                                </div>
                              </div>
