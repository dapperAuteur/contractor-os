      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            <button onClick={() => addLineItem('line_item')} className="mt-2 text-xs text-amber-600 hover:underline font-medium flex items-center gap-1">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              {invoice.invoice_number_prefix && (
                <span className="px-2 py-0.5 rounded-full text-xs font-medium bg-amber-500/10 text-amber-700">
                  {invoice.invoice_number_prefix}
                </span>
              )}
            </div>
