    ...
    <div className="text-white max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
          <MessageCircle className="w-7 h-7 text-fuchsia-400" /> Messages
        </h1>
      </div>
...
export default function StudentMessagesPage() {
  return (
    <Suspense fallback={<div className="flex justify-center py-20"><Loader2 className="w-8 h-8 animate-spin text-fuchsia-500" /></div>}>
      <MessagesContent />
    </Suspense>
  );
}
